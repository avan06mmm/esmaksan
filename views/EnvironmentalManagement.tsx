...
const pageLocal: Record<string, any> = {
  tr: {
    ...
    intro1: '<strong className="text-ink">ESMAKSAN Makine</strong> olarak; faaliyet gösterdiğimiz savunma sanayii ve makine üretimi alanlarında doğaya olan sorumluluğumuzun farkındayız. Bu doğrultuda, <strong className="text-ink">ISO 14001 Çevre Yönetim Sistemi</strong> kurarak çevreye duyarlı bir üretim modelini benimsedik.',
    ...
    closing1: 'Üretim süreçlerimizin her detayında doğayı koruma vizyonumuzu benimsiyoruz. <strong className="text-ink">ISO 14001 sertifikamız</strong> çevreye olan taahhüdümüzün ve sürdürülebilir kalite anlayışımızın resmi bir kanıtıdır.',
  ...
  en: {
    ...
    intro1: 'As <strong className="text-ink">ESMAKSAN Machinery</strong>, we are aware of our responsibility towards nature in the defense industry and machinery production sectors where we operate. In this direction, we have adopted an environmentally friendly production model by establishing the <strong className="text-ink">ISO 14001 Environmental Management System</strong>.',
    ...
    closing1: 'We adopt our vision of protecting nature in every detail of our production processes. Our <strong className="text-ink">ISO 14001 certificate</strong> is official proof of our commitment to the environment and our understanding of sustainable quality.',
  ...
  ru: {
    ...
    intro1: 'Как <strong className="text-ink">ESMAKSAN Machinery</strong>, мы осознаем свою ответственность перед природой в сферах оборонной промышленности и машиностроения, в которых мы работаем. В этом направлении мы внедрили экологически чистую модель производства, создав <strong className="text-ink">Систему экологического менеджмента ISO 14001</strong>.',
    ...
    closing1: 'Мы придерживаемся нашего видения защиты природы в каждой детали наших производственных процессов. Наш <strong className="text-ink">сертификат ISO 14001</strong> является официальным подтверждением нашей приверженности окружающей среде и нашего понимания устойчивого качества.',
  ...
  ar: {
    ...
    intro1: 'بصفتنا <strong className="text-ink">ESMAKSAN Machinery</strong>، نحن ندرك مسؤوليتنا تجاه الطبيعة في قطاعات الصناعات الدفاعية وإنتاج الآلات التي نعمل فيها. في هذا الاتجاه، اعتمدنا نموذج إنتاج صديق للبيئة من خلال إنشاء <strong className="text-ink">نظام الإدارة البيئية ISO 14001</strong>.',
    ...
    closing1: 'نحن نتبنى رؤيتنا لحماية الطبيعة في كل تفاصيل عمليات الإنتاج لدينا. تُعد <strong className="text-ink">شهادة ISO 14001</strong> الخاصة بنا دليلاً رسميًا على التزامنا تجاه البيئة وفهمنا للجودة المستدامة.',
            ...
            >
              ...
              <div className="mt-8 pt-6 border-t border-ink/10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                  ...
                  <p className="text-xl font-black text-ink tracking-tight">ISO 14001:2015</p>
                </div>

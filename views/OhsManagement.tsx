...
const pageLocal: Record<string, any> = {
  tr: {
    ...
    intro1: '<strong className="text-white">ESMAKSAN Makine</strong>, en değerli kaynağının "insan" olduğunun bilinciyle, <strong className="text-white">ISO 45001 İş Sağlığı ve Güvenliği Yönetim Sistemi</strong>\'ni tüm tesislerinde ve operasyonlarında ödünsüz şekilde uygulamaktadır.',
    ...
    closing1: 'Üretim süreçlerimizin devamlılığını ancak güvenli bir çalışma ortamıyla koruyabiliriz. <strong className="text-white">ISO 45001 sertifikamız</strong> bu çabalarımızın ve çalışanımıza verdiğimiz değerin resmi bir göstergesidir.',
  ...
  en: {
    ...
    intro1: 'With the awareness that its most valuable resource is "human", <strong className="text-white">ESMAKSAN Machinery</strong> implements the <strong className="text-white">ISO 45001 Occupational Health and Safety Management System</strong> uncompromisingly in all its facilities and operations.',
    ...
    closing1: 'We can only maintain the continuity of our production processes with a safe working environment. Our <strong className="text-white">ISO 45001 certificate</strong> is an official indicator of our efforts and the value we place on our employees.',
  ...
  ru: {
    ...
    intro1: 'Осознавая, что самым ценным ресурсом является "человек", <strong className="text-white">ESMAKSAN Machinery</strong> бескомпромиссно внедряет <strong className="text-white">Систему менеджмента охраны труда и техники безопасности ISO 45001</strong> на всех своих объектах и в операциях.',
    ...
    closing1: 'Мы можем поддерживать непрерывность наших производственных процессов только при наличии безопасной рабочей среды. Наш <strong className="text-white">сертификат ISO 45001</strong> является официальным показателем наших усилий и той ценности, которую мы придаем нашим сотрудникам.',
  ...
  ar: {
    ...
    intro1: 'إدراكاً منها أن أثمن مواردها هو "الإنسان"، تطبق <strong className="text-white">ESMAKSAN Machinery</strong> <strong className="text-white">نظام إدارة الصحة والسلامة المهنية ISO 45001</strong> بصرامة في جميع مرافقها وعملياتها.',
    ...
    closing1: 'لا يمكننا الحفاظ على استمرارية عمليات الإنتاج لدينا إلا من خلال بيئة عمل آمنة. تعتبر <strong className="text-white">شهادة ISO 45001</strong> الخاصة بنا مؤشرًا رسميًا على جهودنا والقيمة التي نوليها لموظفينا.',
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start justify-between">
          ...
          >
            ...
            <a 
              href={pdfUrl} 
              download 
              className="mt-4 flex items-center justify-center gap-2 w-full py-3 bg-ink text-white rounded-lg font-bold hover:bg-brand hover:text-ink transition-all duration-300 uppercase tracking-wider text-[11px] shadow-md shadow-ink/5"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            >
              ...
              <div className="mt-8 pt-6 border-t border-white/10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                  ...
                  <p className="text-xl font-black text-white tracking-tight">ISO 45001:2018</p>
                </div>
